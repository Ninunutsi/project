...
const Registration = () => {
    ...
    const [userData, setUserData] = useLocalStorage('user', {image: '', name:''})
  ...
  // data to local storage
    const handleImageChange = (event) => {     
        ...
        if (file) {
            ...
            reader.onload = () => {
            setUserData((prevValue) => ({...prevValue, image: reader.result}))
    ...
    // after submitt if rquirements are met goes to next page which is form
    ...
    <main className='registration-container'>
      ...
      <div className="registration-form fadeIn">
        ...
        <form action="" onSubmit={handleSubmit}>
            ...
            <label htmlFor='image' 
                    className={formSubmit.image ? 'label-text' : "label-text red"}>
              add a photo
              </label>

            <label htmlFor="image" 
                    className={formSubmit.image ? 'photo-label' : "photo-label error"}>
            ...
            <label htmlFor='name' 
              className={formSubmit.name ? 'label-text' : "label-text red"}>
                fill in you name
              </label>
