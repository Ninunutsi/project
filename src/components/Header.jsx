  ...
  return (
    <header className='header'>
        <section className='left-header'>
            ...
            <NavLink className='api' to={`${location.pathname.includes('/api') ? '/registration/form' : '/api'}`}><h2 className='api'>
        ...
        {/* MODAL */}
        <Modal user={user} isOpen={isOpen} closeModal={closeModal} logOut={logOut} />
    </header>
  )
}
